...
-   To have functional reporting to PowerBI, you need to add `CONFIG_CUSTOMER_ID` named secret to Github Secrets with Customer ID of an environment where tests will be running. Customer ID can be got from the URL -> go to microapps admin and the first part of the url is Customer ID like this: `https://CUSTOMERID.us.iws.cloud.com/`
...
Also you need to add `CONFIG_CUSTOMER_ID` named secret to Github Secrets with Customer ID of an environment where tests will be running. Customer ID can be got from the URL -> go to microapps admin and the first part of the url is Customer ID like this: `https://CUSTOMERID.us.iws.cloud.com/`
